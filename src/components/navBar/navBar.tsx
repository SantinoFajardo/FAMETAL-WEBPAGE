  ...
  return (
    <nav className="bg-white px-2 sm:px-4 py-2.5 fixed w-full z-20 top-0 left-0 border-b-blue-500 border-b-[.5px]">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div
          className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-transparent z-[-1] left-0 w-full h-full md:w-auto transition-all duration-500 ease-in ${
